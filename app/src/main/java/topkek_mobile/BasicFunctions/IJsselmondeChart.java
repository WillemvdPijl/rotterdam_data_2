 ...
 */
public class IJsselmondeChart extends AppCompatActivity{

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ijsselmondechart);
    ...
    private ArrayList<IBarDataSet> getDataSet() {
        ...
        valueSet1.add(v1e3);
        BarEntry v1e4 = new BarEntry(38.000f, 3); // Apr
        valueSet1.add(v1e4);
        ...
        valueSet2.add(v2e4);
        BarEntry v2e5 = new BarEntry(80.000f, 4); // May
        valueSet2.add(v2e5);
