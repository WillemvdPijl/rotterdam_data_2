...
public class FeijenoordChart extends AppCompatActivity {
    ...
    private ArrayList<IBarDataSet> getDataSet() {
        ...
        BarEntry v1e1 = new BarEntry(1.000f, 0); // Jan
        valueSet1.add(v1e1);
        BarEntry v1e2 = new BarEntry(2.000f, 1); // Feb
        valueSet1.add(v1e2);
        BarEntry v1e3 = new BarEntry(3.000f, 2); // Mar
        valueSet1.add(v1e3);
        BarEntry v1e4 = new BarEntry(4.000f, 3); // Apr
        valueSet1.add(v1e4);
        BarEntry v1e5 = new BarEntry(9.000f, 4); // May
        valueSet1.add(v1e5);
        BarEntry v1e6 = new BarEntry(1110.000f, 5); // Jun
        valueSet1.add(v1e6);
        ...
        valueSet2.add(v2e2);
        BarEntry v2e3 = new BarEntry(170.000f, 2); // Mar
        valueSet2.add(v2e3);
        BarEntry v2e4 = new BarEntry(180.000f, 3); // Apr
        valueSet2.add(v2e4);
        BarEntry v2e5 = new BarEntry(90.000f, 4); // May
        valueSet2.add(v2e5);
        BarEntry v2e6 = new BarEntry(10.000f, 5); // Jun
        valueSet2.add(v2e6);
        BarEntry v2e7 = new BarEntry(111.000f,6); // jul
        valueSet2.add(v2e7);
        BarEntry v2e8 = new BarEntry(110.000f,7); // aug
        valueSet2.add(v2e8);
