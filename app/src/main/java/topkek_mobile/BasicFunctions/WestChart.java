 ...
 */
public class WestChart extends AppCompatActivity{

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_westchart);
    ...
    private ArrayList<IBarDataSet> getDataSet() {
        ...
        valueSet1.add(v1e1);
        BarEntry v1e2 = new BarEntry(46.000f, 1); // Feb
        valueSet1.add(v1e2);
        BarEntry v1e3 = new BarEntry(6.000f, 2); // Mar
        valueSet1.add(v1e3);
        BarEntry v1e4 = new BarEntry(33.000f, 3); // Apr
        valueSet1.add(v1e4);
        ...
        BarEntry v2e1 = new BarEntry(1.000f, 0); // Jan
        valueSet2.add(v2e1);
        ...
        valueSet2.add(v2e4);
        BarEntry v2e5 = new BarEntry(220.000f, 4); // May
        valueSet2.add(v2e5);
