 ...
 */
public class NoordCharts extends AppCompatActivity{
    ...
    private ArrayList<IBarDataSet> getDataSet() {
        ...
        BarEntry v1e1 = new BarEntry(15.000f, 0); // Jan
        valueSet1.add(v1e1);
        BarEntry v1e2 = new BarEntry(9.000f, 1); // Feb
        valueSet1.add(v1e2);
        BarEntry v1e3 = new BarEntry(8.000f, 2); // Mar
        valueSet1.add(v1e3);
        BarEntry v1e4 = new BarEntry(2.000f, 3); // Apr
        valueSet1.add(v1e4);
        BarEntry v1e5 = new BarEntry(6.000f, 4); // May
        valueSet1.add(v1e5);
        ...
        valueSet2.add(v2e1);
        BarEntry v2e2 = new BarEntry(80.000f, 1); // Feb
        valueSet2.add(v2e2);
        BarEntry v2e3 = new BarEntry(180.000f, 2); // Mar
        valueSet2.add(v2e3);
        BarEntry v2e4 = new BarEntry(75.000f, 3); // Apr
        valueSet2.add(v2e4);
        BarEntry v2e5 = new BarEntry(35.000f, 4); // May
        valueSet2.add(v2e5);
